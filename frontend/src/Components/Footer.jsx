...
export const Footer = () => {
  ...
  return (
    <div className="bg-green-100   py-8 px-4 sm:px-8 md:px-12 lg:px-20 font-serif">
      <div className="container mx-auto flex flex-col md:flex-row justify-between gap-6 md:gap-10">
        ...
        <ul className="flex flex-col space-y-3 ">
          <li className="text-xl font-semibold">Consultancy</li>
          <li className="hover:text-green-900 transition-colors">About</li>
          <li className="hover:text-green-900 transition-colors">Marketing</li>
        </ul> */}

        {/* <ul className="flex flex-col space-y-3">
          <li className="text-xl font-semibold">Help</li>
          <li className="hover:text-green-900 transition-colors">FAQs</li>
          <Link to="/contact"><li className="hover:text-green-900 transition-colors">Contact Us</li></Link>
          <li className="hover:text-green-900 transition-colors">Vendor Connect</li>
        </ul> */}
