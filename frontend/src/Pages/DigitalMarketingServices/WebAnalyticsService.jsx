      ...
      >
        ...
        Your browser does not support the video tag.
                ...
                <div className="justify-center absolute inset-0 flex items-center bg-black bg-opacity-0 text-white text-center p-4">
                    <h1 className={`text-2xl md:text-4xl font-bold mb- `}>Web Analytics Service</h1>
                </div>
            </div>
            ...
            <div className={`${isTextVisible ? 'animate-slide' : ''}`}>
                <div className=" text-gray-800 p-6 sm:p-8 md:p-10 lg:p-12 font-serif ">
                    <div className="relative">
                        ...
                        {/* <h1 className={`text-2xl md:text-5xl text-green-700 text-center font-bold mb- ${isTextVisible ? 'animate-slide' : ''}`}> </h1> */}
                        <div className="md:flex justify-center items-center gap-10 p-10 ">
                            <div>
                                <h1 className="text-lg sm:text-2xl md:text-xl font-bold mb- text-green-950 mb-2">Monitor Your Audience <span className='text-green-800'>for Higher Conversions </span> </h1>
