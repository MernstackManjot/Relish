...
<div className="bg-gradient-to-r from-yellow-50 to-red 7ext-gray-800 p-6 sm:p-8 md:p-10 lg:p-12 font-serif min-h-screen">
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto ">
                        <div>
                            <h1 className="text-2xl sm:text-2xl md:text-3xl font-bold mb-4 text-red-700 text-center"> Conversion Rate Optimization (CRO)</h1>
                        ...
                        <div>
                            <h2 className="text-xl mt-10 font-semibold mb-2 text-red-700">Our CRO Services Include:
                            </h2>
