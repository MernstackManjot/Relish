        ...
        <>
            <div className='relative w-full h-[90px] md:h-[200px] lg:h-[180px] overflow-hidden font-thin'>
                ...
                <div className="justify-center absolute inset-0 flex items-center bg-black bg-opacity-0 text-white text-center p-4">
                    <h1 className={`text-2xl md:text-4xl font-bold mb- `}>Online Reputation Management   </h1>
                </div>
            </div>
            ...
            <div className={`${isTextVisible ? 'animate-slide' : ''}`}>
                ...
                <div className='md:flex justify-center items-center p-16 bg-green-100 gap-40'>
                    <div>
                        <img src='https://peerdemo.in/relish/wp-content/uploads/2024/09/IMAGE5-1024x1018.png' className='rounded-lg md:max-w-xs mb-6' />
                    </div>
                    <div>
                        <h1 className="text-2xl sm:text-2xl md:text-3xl font-bold mb-4 text-green-950 gap-3">Software tools <span className='text-green-800'> we use</span>
                        </h1>
