...
export const PharmaceuticalProducts = () => {
  ...
  return (
    ...
    <div className="justify-center absolute inset-0 flex items-center bg-black bg-opacity-0 text-white text-center p-4">
      <h1 className={`text-2xl md:text-4xl font-bold mb- `}> Pharmaceutical Products (Active Ingredients)</h1>
    </div>
  </div>
    <div className=" text-gray-800 p-6 sm:p-8 md:p-10 lg:p-7 font-serif ">
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto ">
          ...
          <img
              src="https://img.freepik.com/free-photo/packings-pills-capsules-medicines_1339-2253.jpg?uid=R166271515&ga=GA1.1.830621292.1707550020&semt=ais_hybrid"
              alt="Tea"
              className="w-full md:w-1/2 h-96 object-cover rounded-lg shadow-md"
            />
        <ul className="list-disc pl-5 space-y-2 text-base sm:text-lg">
            <li> <span className='font-bold'>Description:</span>India imports raw materials for pharmaceutical manufacturing.</li>
            <li> <span className='font-bold'>Major Suppliers:</span> China, Italy, Germany, USA.
            </li>
            <li> <span className='font-bold'>Usage:</span>Pharmaceutical and medical products manufacturing.</li>
        </ul>
          </div>
        </div>
      </div>
