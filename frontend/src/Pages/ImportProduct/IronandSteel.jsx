...
export const IronandSteel = () => {
  ...
  return (
    ...
    <div className="justify-center absolute inset-0 flex items-center bg-black bg-opacity-0 text-white text-center p-4">
      <h1 className={`text-2xl md:text-4xl font-bold mb- `}>  Iron and Steel</h1>
    </div>
  </div>
    <div className=" text-gray-800 p-6 sm:p-8 md:p-10 lg:p-7 font-serif ">
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto ">
          ...
          <img
              src="https://img.freepik.com/free-photo/abstract-gray-background-metal-texture-generative-ai_169016-30459.jpg?uid=R166271515&ga=GA1.1.830621292.1707550020&semt=ais_hybrid"
              alt="Tea"
              className="w-full md:w-1/2 h-96 object-cover rounded-lg shadow-md"
            />
        <ul className="list-disc pl-5 space-y-2 text-base sm:text-lg">
            <li> <span className='font-bold'>Description:</span>Finished iron and steel products and raw materials like iron ore.</li>
            <li> <span className='font-bold'>Major Suppliers:</span> South Korea, China, Japan.</li>
            <li> <span className='font-bold'>Usage:</span> Construction, automotive, and heavy machinery.</li>
        </ul>
          </div>
        </div>
      </div>
