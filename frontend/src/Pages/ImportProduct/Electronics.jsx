  ...
  return (
    ...
    <div className='relative w-full h-[90px] md:h-[200px] lg:h-[180px] overflow-hidden font-thin'>
      ...
      <div className="justify-center absolute inset-0 flex items-center bg-black bg-opacity-0 text-white text-center p-4">
        <h1 className={`text-2xl md:text-4xl font-bold mb- `}>  Electronics and Electrical Equipment</h1>
      </div>
    </div>
    ...
    <div className=" text-gray-800 p-6 sm:p-8 md:p-10 lg:p-7 font-serif ">
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto ">
          ...
          <img
              src="https://img.freepik.com/free-photo/different-electrical-tools-wooden-background-flat-lay_169016-24825.jpg?uid=R166271515&ga=GA1.1.830621292.1707550020&semt=ais_hybrid"
              alt="Tea"
