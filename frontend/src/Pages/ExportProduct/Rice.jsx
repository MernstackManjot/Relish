      ...
      <div className="bg-green-50 text-gray-800 p-6 sm:p-8 md:p-10 lg:p-7 font-serif min-h-screen">
        <div className="relative">
          ...
          <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl sm:text-3xl font-bold mb-10 text-green-800 text-center">  Rice
            </h1>
            
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-10">
              <div className="relative w-full md:w-1/2 h-96">
                <img
                  src="https://img.freepik.com/premium-photo/jasmine-rice-background_3236-170.jpg?ga=GA1.1.830621292.1707550020&semt=ais_hybrid"
                  alt=""
              ...
              <p className="text-base sm:text-lg md:w-1/2 text-center">
                We specialize in exporting different types of rice, including basmati and non-basmati, known for their
                taste and quality.
              </p>
            </div>
          </div>
