    ...
    return (
      ...
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-bold mb-10 text-green-800 text-center">  Chemicals
</h1>
       
          <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-10">
            <div className="relative w-full md:w-1/2 h-96">
              <img
                src="https://img.freepik.com/free-photo/front-view-science-elements-with-chemicals-arrangement_23-2148697187.jpg?ga=GA1.2.830621292.1707550020&semt=ais_hybrid"
                alt=""
            ...
            We offer a broad range of industrial and agricultural chemicals, adhering to stringent international
