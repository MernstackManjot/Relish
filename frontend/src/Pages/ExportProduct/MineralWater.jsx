    ...
    return (
      ...
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-bold mb-10 text-green-800 text-center">  Mineral Water
</h1>
       
          <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-10">
            <div className="relative w-full md:w-1/2 h-96">
              <img
                src="https://img.freepik.com/premium-photo/water-bottle-with-word-water-it_987366-65791.jpg?ga=GA1.1.830621292.1707550020&semt=ais_hybrid"
                alt=""
            ...
            We supply premium-grade mineral water, sourced from natural springs and processed to ensure
