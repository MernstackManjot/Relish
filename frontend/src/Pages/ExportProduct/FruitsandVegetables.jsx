...
export const FruitsandVegetables = () => {
    ...
    return (
        ...
        <div className="justify-center absolute inset-0 flex items-center bg-black bg-opacity-0 text-white text-center p-4">
          <h1 className={`text-2xl md:text-4xl font-bold mb- `}>Fruits and Vegetables  </h1>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="max-w-4xl mx-auto">
          {/* <h1 className="text-2xl sm:text-3xl font-bold mb-10 text-green-800 text-center ml-12">
</h1> */}
